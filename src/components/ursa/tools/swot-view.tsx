...
const COMPETITORS: Competitor[] = [
  ...
  },
  {
    ...
    opportunity: "Ursa can win the immediate-block comparison through bear identity and two-bar theatre",
    threat: "Captures walk-by traffic that could enter Ursa first if the storefront is more inviting",
    ursaImplication: "Win the block. Bear identity, roastery visibility, and named-drink storytelling make Ursa the obvious choice at 35 metres.",
  },
  {
    name: "Dulce Ciudad",
    area: "Miraflores · 50m",
